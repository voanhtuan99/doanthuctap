...
export default class EditProduct extends Component {
    ...
    handleShowEditproduct() {
        sessionStorage.setItem("ideditproduct", this.props.product._id)
        this.props.handleShowEditproduct()
    }

    handleShowDelProduct() {
        sessionStorage.setItem("iddelproduct", this.props.product._id)
        this.props.handleShowDelProduct()
